...
> 狀態:**音譯風格已定**(使用者 2026-06-20):副標「**烈火神兵**」(沿用《軟體世界》1991 年該作攻略的標題,而非把 Trial by Fire 直譯為「烈火試煉」);人名地名走**阿拉伯/波斯風**音譯(QFG2 為一千零一夜題材)。QFG 自創種族名(獅人/卡塔/索魯斯)維持原音譯。
...
- 耐力 — Stamina
- 驅散藥水 — Dispel Potion。_Avoid_: 把 Reversal 也譯「驅散」(撞名)
- 反轉(術) — Reversal(把敵方法術原樣彈回的法術;遊戲譯文一律「反轉」)。_Avoid_: 驅散、逆轉、反彈護體
- 原力箭 — Force Bolt(攻擊法術;譯名參考《魔獸世界》)。遊戲譯文已統一(原力箭連發 = Force Bolt Flurry 小遊戲)。_Avoid_: 力量箭、力箭、力矢、力鏢、力場箭、衝擊彈
...
- 烏胡拉 — Uhura(公會會長兼格鬥教官;說 pidgin → 中文略簡略粗獷)
- 烏加特 — Ugarte(走私水的販子)
- 塔什塔里 — Tashtari(燈商);薩巴 — Saba(籃商);拉珊 — Lasham(花草商)

## 敬稱 / 語域

- 閣下 — Effendi(阿拉伯敬稱,NPC 對英雄的尊稱)。_Avoid_: 直接音譯「埃芬迪」
- 偉大的英雄 — great Hero;年輕的冒險者 — young adventurer
- **語氣層**:對白/敘述採《軟體世界》三大誌生動口語(對讀者直呼、活潑);角色各有語域(Uhura 粗獷、敬語 NPC 謙卑)。
